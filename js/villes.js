...
var VILLES_PAR_PAYS = {
  'france': ['Paris','Lyon','Marseille','Toulouse','Nice','Nantes','Strasbourg','Montpellier',
    ...
    'Cherbourg','Évreux','Chartres','Beauvais','Compiègne','Soissons','Valenciennes',
    'Dunkerque','Calais','Arras','Lens','Douai','Roubaix','Tourcoing','Béthune','Maubeuge',
    'Thionville','Forbach','Sarreguemines','Haguenau','Sélestat','Saverne',
    ...
    'Le Havre','Alençon','Flers','Vire','Saint-Brieuc','Vannes','Morlaix',
    'Périgueux','Bergerac','Agen','Auch','Montauban','Albi','Castres','Carcassonne','Narbonne',
    'Béziers','Sète','Arles','Fréjus','Saint-Tropez','Menton','Monaco','Grasse','Draguignan',
    ...
    'Alsace','Lorraine','Champagne','Périgord','Dordogne','Gascogne','Languedoc',
    'Roussillon','Camargue','Luberon','Verdon','Vercors','Chartreuse',
    'Côte d\'Azur','Côte Atlantique','Côte Fleurie','Baie de Somme',
    'Mont-Saint-Michel','Gorges du Verdon','Calanques de Marseille'],
  ...
  'espagne': ['Madrid','Barcelone','Valence','Séville','Saragosse','Málaga','Murcie',
    ...
    'Îles Baléares','Îles Canaries','La Rioja','Algarve espagnol',
    'Costa del Sol','Costa Brava','Costa Blanca','Costa Dorada',
    'Costa de la Luz','Costa Verde','Rías Baixas','Sierra Nevada'],
  ...
  'italie': ['Rome','Milan','Naples','Turin','Palerme','Gênes','Bologne','Florence','Bari',
    ...
    'Taormine','Agrigente','Syracuse','Raguse','Trapani','Cefalù',
    ...
    'Côte Amalfitaine','Riviera Ligure','Lac de Côme','Lac Majeur','Lac de Garde',
    'Chianti','Val d\'Orcia','Dolomites','Maremme'],
  ...
  'allemagne': ['Berlin','Hambourg','Munich','Cologne','Francfort','Stuttgart','Düsseldorf',
    ...
    'Forêt-Noire','Bavière','Allgäu','Ruhr','Rhénanie','Westphalie',
    'Route Romantique','Lac de Constance','Île de Rügen'],
  ...
  'royaume-uni': ['Londres','Édimbourg','Manchester','Birmingham','Liverpool','Bristol',
    ...
    'Northumberland','East Anglia','Kent','Sussex','Dorset','Somerset',
    'Vallée de la Wye','Pembrokeshire','Snowdonia','Highlands écossais'],
  ...
  'maroc': ['Casablanca','Marrakech','Fès','Rabat','Tanger','Agadir','Meknès','Oujda',
    ...
    'Rif','Atlas','Anti-Atlas','Vallée du Drâa','Vallée du Dadès',
    'Désert du Sahara marocain','Côte Atlantique marocaine'],
  ...
  'etats-unis': ['New York','Los Angeles','Chicago','San Francisco','Miami','Las Vegas',
    ...
    // États et régions américains
    'Californie','Floride','Hawaï','Alaska','Nouvelle-Angleterre',
    'Côte Est','Côte Ouest','Grand Sud','Rocheuses','Pacifique Nord-Ouest',
    'Grands Lacs','Midwest','Route 66','Parcs nationaux de l\'Ouest américain'],
